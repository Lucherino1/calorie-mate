        ...
        <ul class="flex lg:gap-10 xl:gap-14 mt-5">
          <li class="text-center">
            <p class="text-gray-light">
              Carbs:<br><b class="text-gray-dark text-xl">{{ calcedNutrition.carbs }}</b> g
            </p>
          </li>

          <li class="text-center">
            <p class="text-gray-light">
              Proteins:<br><b class="text-gray-dark text-xl">{{ calcedNutrition.proteins }}</b> g
            </p>
          </li>

          <li class="text-center">
            <p class="text-gray-light">
              Fats:<br><b class="text-gray-dark text-xl">{{ calcedNutrition.fats }}</b> g
            </p>
          </li>
